...
interface TopicCardProps {
  ...
  onClick?: (topic: BrowseCategoryTopic) => void;
}

export const TopicCard: React.FC<TopicCardProps> = ({ topic, onClick }) => {
  return (
    <div
      className="flex-shrink-0 w-48 h-32 rounded-lg overflow-hidden relative group cursor-pointer shadow-md hover:shadow-xl transition-shadow duration-300"
